...
const cities = data.map(contact => contact.address.city);
console.log(cities);
// create an array of latitude and longitude coordinate pairs
const coords = data.map(contact => [
  contact.address.geo.lat,
  contact.address.geo.lng
]);
console.log(coords);
// create an array of objects that contain the company's catchPhrase and bs
const phrases = data.map(contact => {
  return {
...
// get array of objects and sort them
data.sort((a, b) => (a.name > b.name ? 1 : -1));
const names2 = data.map(contact => contact.name);
// console.log(data);
console.log(names2);
console.table(data);
